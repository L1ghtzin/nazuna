...
const CONFIG_FILE = path.join(process.cwd(), 'dados', 'config.json');
...
const print = {
    ...
    header: () => {
        print.separator();
        console.log(`${colors.bold}🚀 Configurador Gênesis Chainy - Versão ${version}${colors.reset}`);
...
async function main() {
    ...
    print.message(`🎉 Chainy configurado e pronto para uso! Versão: ${version}`);
}
